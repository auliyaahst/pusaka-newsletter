    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          editionNumber: edition.editionNumber ? edition.editionNumber.toString() : '',
          theme: edition.theme || '',
          coverImage: edition.coverImage || '',
          isPublished: edition.isPublished
        })

        // Parse and set cover images if they exist
          ...
          <div className="mb-6 sm:mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">Update edition details and manage content.</p>
              </div>
              <Link
