...
export default function EditEditionPage() {
  ...
  // Check permissions - only EDITOR, SUPER_ADMIN can edit editions
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: 'var(--accent-cream)' }}>
        <div className="text-center">
          ...
          <p className="text-gray-600">You don&apos;t have permission to edit editions.</p>
          <button
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          publishDate: new Date(edition.publishDate).toISOString().split('T')[0],
      ...
      toast.error('Error loading edition')
    } finally {
      setIsLoading(false)
    }
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!submitData.description.trim()) {
      toast.error('Edition description is required')
      return
    }
    
    if (!submitData.content.trim() || submitData.content === '<p></p>') {
      toast.error('Edition content is required')
      return
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(`Error: ${error.message || 'Failed to update edition'}`)
      }
    } catch (error) {
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="mb-8">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Edit Edition</h1>
                  </div>
                  <p className="text-gray-600">Update your newsletter edition content and settings</p>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mb-2">The name of this newsletter edition</p>
                    <input
                      type="text"
                      id="title"
                      required
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-2">Sequential number for this edition</p>
                      <input
                        type="number"
                        id="editionNumber"
                        required
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, editionNumber: Number.parseInt(e.target.value) || 1 }))}
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-2">When this edition will be published</p>
                      <input
                        type="date"
                        id="publishDate"
                        required
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mb-2">A brief description of what this edition covers</p>
                    <textarea
                      id="description"
                      required
                      ...
                      rows={3}
                      placeholder="Describe what readers can expect in this edition..."
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-gray-500 mb-4 bg-blue-50 p-3 rounded-lg">
                    💡 Use the rich text editor below to edit the main content for this edition.
                  </p>
                  ...
                  <div>
                    ...
                    <div className="border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-transparent">
                      <EnhancedEditor 
                        ...
                        placeholder="Write the introduction or main content for this edition..."
                        height="400px"
