            ...
            <div className="bg-white rounded-2xl shadow-xl">
              <div className="p-6 sm:p-8">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-600">Create a new newsletter edition to organize your content</p>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Enter edition title (e.g., Weekly Insights #1)"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-gray-500 mb-4 bg-blue-50 p-3 rounded-lg">
                    💡 Use the rich text editor below to create the main content for this edition. This could be an introduction, summary, or featured content.
                  </p>
