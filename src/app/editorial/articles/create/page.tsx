...
export default function CreateArticlePage() {
  ...
  // Check permissions - only EDITOR, SUPER_ADMIN can create articles
  ...
  return (
    <div className="min-h-screen flex flex-col">
            ...
            <div className="bg-white rounded-2xl shadow-xl">
              <div className="p-6 sm:p-8">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-600">Fill in the details below to create your article. Fields marked with * are required.</p>
                </div>
      ...
      {/* Fixed Footer */}
      <footer className="fixed bottom-0 left-0 right-0 z-30 text-white py-4 px-6" style={{backgroundColor: 'var(--accent-blue)'}}>
