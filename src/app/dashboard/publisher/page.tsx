...
export default function PublisherDashboardPage() {
  ...
  const tabs = [
    ...
    { id: 'review', label: 'Article Review', shortLabel: 'Review', icon: '👁️' },
    { id: 'approved', label: 'Approved Articles', shortLabel: 'Approved', icon: '✅' },
    { id: 'statistics', label: 'Publisher Stats', shortLabel: 'Stats', icon: '📊' }
  ]
          ...
          <div className="flex justify-between items-center py-2 sm:py-3">
            <div className="flex items-center min-w-0 flex-1">
              ...
              <h1 className="text-base sm:text-lg font-semibold text-gray-900 truncate">
                <span className="hidden sm:inline">Publisher Dashboard</span>
                <span className="sm:hidden">Publisher</span>
              </h1>
            </div>
        ...
        <div className="sm:hidden bg-white border-b shadow-lg">
          <div className="px-3 py-2 border-b">
            <div className="text-xs text-gray-600">
              ...
              <span className="inline-block mt-1 px-1.5 py-0.5 bg-purple-100 text-purple-800 rounded text-xs">
                {session?.user?.role}
              </span>
            </div>
          </div>
