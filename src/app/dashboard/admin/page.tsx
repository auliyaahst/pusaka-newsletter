...
export default function AdminDashboardPage() {
  ...
  const tabs = [
    { id: 'users', label: 'User Management', shortLabel: 'Users', icon: '👥' },
    { id: 'subscriptions', label: 'Subscriptions', shortLabel: 'Plans', icon: '💳' },
    { id: 'statistics', label: 'Web Statistics', shortLabel: 'Stats', icon: '📊' }
  ]
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div className="hidden sm:flex items-center text-xs text-gray-600">
                <div className="text-right">
                  ...
                  <span className="inline-block px-1.5 py-0.5 bg-red-100 text-red-800 rounded text-xs">
                    {session?.user?.role}
                  </span>
                </div>
              </div>
        ...
        <div className="sm:hidden bg-white border-b shadow-lg">
          <div className="px-3 py-2 border-b">
            <div className="text-xs text-gray-600">
              ...
              <span className="inline-block mt-1 px-1.5 py-0.5 bg-red-100 text-red-800 rounded text-xs">
                {session?.user?.role}
              </span>
            </div>
          </div>
