  ...
  const addHighlight = () => {
    if (selectedText && selectedArticle) {
      const newHighlight: TextHighlight = {
        ...
        startOffset: 0, // We'll implement proper offset calculation later
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <h3 className="text-lg font-medium text-gray-900 mb-2">Article Review Queue</h3>
                ...
                {articles.map((article) => (
                  <button
                    ...
                    className={`w-full p-4 text-left hover:bg-gray-50 focus:outline-none focus:bg-gray-50 ${
                      selectedArticle?.id === article.id ? 'bg-purple-50 border-r-2 border-purple-500' : ''
                    }`}
                  >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full mx-4">
            <div className="text-center mb-4">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Decline Article</h3>
      ...
      {showHighlightModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="mb-4">
              <label htmlFor="highlightComment" className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                className="flex-1 bg-yellow-600 hover:bg-yellow-700 text-white py-2 px-4 rounded-md font-medium"
              >
                Add Highlight
              </button>
            </div>
