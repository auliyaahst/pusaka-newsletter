    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Create and manage newsletter editions. Control which editions are published to readers.</p>
        </div>
        <button
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">Manage all newsletter editions and control their publication status.</p>
        </div>
