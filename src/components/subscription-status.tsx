    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-8 mb-8 shadow-sm">
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-center space-x-4">
          <div className={`w-12 h-12 rounded-xl flex items-center justify-center border ${getStatusColor(subscription.subscriptionType, subscription.isActive)}`}>
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-900">{getSubscriptionDisplayName(subscription.subscriptionType)}</h3>
        ...
        <span className={`px-3 py-1.5 rounded-lg text-sm font-medium border ${getStatusColor(subscription.subscriptionType, subscription.isActive)}`}>
        ...
        <div className="bg-gray-50 rounded-xl p-4 mb-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg font-semibold text-gray-700">{formatDate(subscription.subscriptionEnd)}</p>
            </div>
            {daysRemaining !== null && daysRemaining > 0 && (
              <div className="text-right">
                <p className="text-sm text-gray-500">Days remaining</p>
                <p className={`text-lg font-semibold ${daysRemaining <= 7 ? 'text-amber-600' : 'text-gray-700'}`}>
                  {daysRemaining}
                </p>
              </div>
            )}
      ...
      <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-r from-red-50 to-red-100 border border-red-200 rounded-xl p-6">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <h4 className="text-lg font-semibold text-red-800 mb-2">Trial Expired</h4>
                ...
                return (
                  <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-6">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <h4 className="text-lg font-semibold text-amber-800 mb-2">Trial Ending Soon</h4>
              ...
              return (
                <div className="bg-gradient-to-r from-emerald-50 to-green-50 border border-emerald-200 rounded-xl p-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h4 className="text-lg font-semibold text-emerald-800 mb-2">Enjoying Your Trial?</h4>
        ...
        {!subscription.trialUsed && subscription.subscriptionType !== 'FREE_TRIAL' && (
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <h4 className="text-lg font-semibold text-blue-800 mb-2">Free Trial Available!</h4>
        ...
        {subscription.isActive && subscription.subscriptionType !== 'FREE_TRIAL' && (
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-6">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="text-lg font-semibold text-gray-800 mb-1">Manage Subscription</h4>
